...
public class GetCheckinsCallbackHandlerTest extends AbstractTest {

    private GetCheckinsCallbackHandler handler;
    
    @Override
    protected void setUp() {
        handler = new GetCheckinsCallbackHandler(new MockContext());
    }
    ...
    public void testSimple() throws Exception {
        ...
        List<Checkin> checkins = handler.getCheckins();
        assertEquals(1, checkins.size());
        Checkin target = checkins.get(0);
